...
open class ARViewController: UIViewController {
    ...
    // Virtual Object Manipulation Properties
    ...
    /// Called when virtual object loading has started. Empty impl.
    /// subclass can use this to notify object loading has started.
    func willLoad(object: VirtualObject, previous: VirtualObject?) {
        //
    }
    ...
    override open func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        if virtualObjectManager.virtualObjects.isEmpty {
            ...
            // NOTE: This is quite a hack, calling button target programatically.
